...
dhd_common_init(osl_t *osh)
{
	...
	if (select_type == 12) {
		bcm_strncpy_s(fw_path, sizeof(fw_path), "/system/vendor/modules/fw_bcm43341b0_ag.bin", MOD_PARAM_PATHLEN-1);
	}
    ...
    //select ap6234
    if(select_type == 12){
        bcm_strncpy_s(nv_path, sizeof(nv_path), "/system/vendor/modules/nvram_ap6234.txt", MOD_PARAM_PATHLEN-1);    
    }
